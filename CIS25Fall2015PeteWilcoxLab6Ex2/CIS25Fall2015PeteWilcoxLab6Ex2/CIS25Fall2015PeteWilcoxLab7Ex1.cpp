...
Please select the first object:
  ...
  (3) Circle 1
  (4) Circle 2
Please select your object (1 through 4): 1
...
Please select the second object:
  ...
  (3) Circle 1
  (4) Circle 2
Please select your object (1 through 4): 2
...
Please select the second object:
  ...
  (3) Circle 1
  (4) Circle 2
Please select your object (1 through 4): 3
...
Please select the second object:
  ...
  (3) Circle 1
  (4) Circle 2
Please select your object (1 through 4): 4
...
This was a good opportunity to use Shape() as an abstract base
class for Circle() and Rectangle(). It allowed me to
significantly reduce the amount of code necessary to perform
some manipulations, particularly when it came to comparing the
different shapes against each other.

The requirement to print each constructor/destructor call makes
the code look pretty ugly, and it is easy to think that you
should try to create these objects without creating the member
data objects first. I believe this is the wrong mindset though
as it would violate the principles of abstraction.
